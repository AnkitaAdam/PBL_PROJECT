...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="css/attendenceMarks.css">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                              echo '<tr>
                                ...
                                <td><input type="number" name="marks'.$counter.'" value="" required max="100" min="0"> /100%</td>
...
<script>
 ...
 function validateForm2(){
    ...
    $(".table tbody tr").each(function(){
        ...
        if (isNaN(marks) || marks < 0 || marks > 100.00) {
            alert("Please enter valid marks (between 0% and 100%) for all students");
...
$(document).ready(function(){
    ...
    $("#convert_marks_btn").click(function(event){
        ...
        if(validateForm2()){
            $(".table tbody tr").each(function(){
                var marksInput = $(this).find("input[type='number']");
                var attendence = parseInt(marksInput.val());
                // Convert marks to out of 20

                var convertedMarks;
                if(attendence>=95.00 && attendence<=100.00 ){
                    convertedMarks=20;
                }else if(attendence>=90.00 && attendence<=95.00){
                    convertedMarks=16;
                }else if(attendence>=85.00 && attendence<=90.00){
                    convertedMarks=12;
                }else if(attendence>=80.00 && attendence<=85.00){
                    convertedMarks=8;
                }else if(attendence>=75.00 && attendence<=80.00){
                    convertedMarks=4;
                }else if(attendence<=75.00){
                    convertedMarks=0;
                }
        ...
        $("#submit_marks_btn").click(function(event){
            ...
            if(validateForm2()){
                ...
                $(".table tbody tr").each(function(){
                    ...
                    attendence = $(this).find("input[type='number']").val();
